...
const newProjectComponentReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case "FETCH_EVENT2_PENDING":
            return { ...state, fetching: true }
        case "FETCH_EVENT2_REJECTED":
...
export default newProjectComponentReducer
